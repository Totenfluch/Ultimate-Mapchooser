...
public APLRes:AskPluginLoad2(Handle:myself, bool:late, String:error[], err_max)
{
	...
	CreateNative("UMC_CreateInvalidMapArray", Native_UMCCreateInvalidMapArray);
...
//native Handle:UMC_CreateInvalidValidMapArray(Handle:kv, const String:group[], bool:isNom, 
//                                      bool:forMapChange);
public Native_UMCCreateInvalidMapArray(Handle:plugin, numParams)
{
	new Handle:kv = CreateKeyValues("umc_rotation");
	new Handle:arg = Handle:GetNativeCell(1);
	KvCopySubkeys(arg, kv);
	...
	new Handle:result = CreateInvalidMapArray(kv, mapcycle, group, isNom, forMapChange);
...
//Create an array of INVALID maps from the given mapcycle and group.
Handle:CreateInvalidMapArray(Handle:kv, Handle:mapcycle, const String:group[], bool:isNom, 
	bool:forMapChange)
{
	if (kv == INVALID_HANDLE)
	{
